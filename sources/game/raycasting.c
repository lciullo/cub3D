...
/*   Updated: 2023/10/18 16:34:24 by cllovio          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_angle_struct_raycasting(t_raycasting *raycasting, t_data *data, \
			t_pointf *xy_vert, t_pointf *xy_hori)
{
			...
			double distance, int i)
{
	...
	draw_game(raycasting, distance, raycasting->angle - raycasting->data->angle, i);
}

static void	draw_vertical_collision(t_raycasting *raycasting, t_pointf *xy, double distance, int i)
{
